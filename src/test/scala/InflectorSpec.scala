...
class InflectorSpec extends Specification with DataTables { def is =
  ...
  def dasherization = {
    ...
    "some_title_and_another" !! "some-title-and-another" |> {
      (src, tgt) => Inflector.dasherize(src) must_== tgt
    }
  }
  ...
  def humanization = {
    ...
    "someTitle_Another" !! "Sometitle another" |> {
      (src, tgt) => Inflector.humanize(src) must_== tgt
    }
  }
  ...
  def stringOrdinalization = {
    ...
    "1000"   !! "1000th" |
    "1001"   !! "1001st" |> {
       (src, tgt) => Inflector.ordinalize(src) must_== tgt
    }
  }
  ...
  def pascalization = {
    ...
    "customer name"                 !! "Customer name"             |> {
       (src, tgt) => Inflector.pascalize(src) must_== tgt
    }
  }
  ...
  def camelization = {
    ...
    "customer_first_name_goes_here" !! "customerFirstNameGoesHere" |
    "customer name"                 !! "customer name"             |> {
       (src, tgt) => Inflector.camelize(src) must_== tgt
    }
  }
  ...
  def titleization = {
    ...
    "some title: The_begining" !!  "Some Title: The Begining" |> {
      (src, tgt) => Inflector.titleize(src) must_== tgt
    }
  }
  ...
  def uncapitalization = {
    ...
    "some title goes here" !! "some title goes here" |
    "some TITLE"           !! "some TITLE"           |> {
      (src, tgt) => Inflector.uncapitalize(src) must_== tgt
    }
  }
  ...
  def underscoring = {
    ...
    "SomeTitleThatWillBeUnderscored"      !! "some_title_that_will_be_underscored" |> {
      (src, tgt) => Inflector.underscore(src) must_== tgt
    }
  }
